  ...
  return (
    <section className="p-10">
      <div className="container">
        {/*grid*/}
        <div className="grid grid-cols-1 items-center gap-10 pb-20 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="body-content">
              ...
              <p>
                Organizations face mounting compliance requirements, evolving cyber threats, and
                higher expectations for uptime and efficiency. nuview helps teams stay compliant,
                secure, and productive without sacrificing performance or predictability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="call-to-action mt-8">
          <h3>Our solution</h3>
          <div className="bg-sapphire-500 flex items-center gap-8 rounded-lg p-10 text-white">
            <Image src={'/images/icon-check-green.png'} alt={'check'} width={67} height={67} />

            <p>
              <strong>We embed security, compliance, and reliability</strong> into a single managed
              ecosystem—so risk decreases while performance and audit readiness increase.
            </p>
          </div>
        </div>
      </div>
